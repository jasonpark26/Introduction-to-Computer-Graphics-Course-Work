...
void raytrace_scene()
{
    ...
    // divide field_of_view by two as the angle is above and below
    // math.stackexchange.com/questions/2532397/calculate-height-of-triangle-given-angle-and-base - for finding h
